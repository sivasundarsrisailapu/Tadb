// Anime Schedule JavaScript - Using Original Data with Countdown
    ...
    if (mobileMenuBtn && mobileMenuOverlay) {
        ...
        mobileNavLinks.forEach(link => {
            link.addEventListener('click', (e) => {
                ...
                // If it's an external link (like index.html, cast-crew.html), allow default behavior
                if (href && (href.includes('.html') || href.startsWith('http'))) {
                    // Close mobile menu and allow navigation
                    mobileMenuOverlay.style.display = 'none';
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Initialize anime schedule functionality
    renderUpcoming();
    renderWeekly();
    renderTvSchedule();
    updateCountdown();
